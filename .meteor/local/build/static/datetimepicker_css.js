...
var HamishiColor = "#C0F64F"; //var HamishiColor="#C0F64F";//Background color of Sunday.
...
var MonthName = ["ינואר", "פבואר", "מרץ", "אפריל", "מאי", "יוני", "יולי", "אוגוסט", "ספטמבר", "אוקטובר", "נובמבר", "צדמבר"];
var WeekDayName1 = ["ראשון", "שני", "שלישי", "רביעי", "חמישי", "שישי", "שבת"];
var WeekDayName2 = ["שני", "שלישי", "רביעי", "חמישי", "שישי", "שבת", "ראשון"];
...
function RenderCssCal(bNewCal)
{
		...
		else
		{
			...
			else
			{
				if (MondayFirstDay === true)
				{
					...
					else if (vDayCount % 5 === 0)
					{
						strCell = GenCell(j, false, HamishiColor);
					}
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<td width='22px'><input type='text' name='minute' maxlength=2 size=1 style=\"WIDTH: 22px\" value=" + Cal.Minutes + " onkeyup=\"javascript:Cal.SetMinute(this.value)\">";
...
function NewCssCal1(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode)
{
}
